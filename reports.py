...
class PdfReport:
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        flatmate1_pay = str(round(flatmate1.pays(bill, flatmate2), 2)) # round( XXXX, 2) to have 53.33
        ...
        pdf.cell(w=0, h=80, txt="Flatmates Bill", border=0, align="C",
                 ln=1)  # ln = to add a cell bellow on the pdf file not next to the current cell
...
class FileSharer:
    def __init__(self, filepath, api_key='AtOv4qA7pT6OophHtYIENz'):
